Pod::Spec.new do |s|
  ...
  s.source_files = 'Authentication/**/*.{h,m}','Categories','Core','Utilities','Extensions/Reconnect/*.{h,m}','Extensions/XEP-0082/*.{h,m}','Extensions/XEP-0203/*.{h,m}','Vendor/libidn/*.h'
  s.ios.source_files = 'Authentication/**/*.{h,m}','Categories','Core','Utilities','Extensions/Reconnect/*.{h,m}','Extensions/XEP-0082/*.{h,m}','Extensions/XEP-0203/*.{h,m}','Vendor/libidn/*.h','Vendor/KissXML/**/*.{h,m}'
